...
const config = Object.freeze({
  ...
  // Firebase Admin SDK
  // Recommended: paste the full service account JSON as FIREBASE_SERVICE_ACCOUNT
  // Fallback: use individual FIREBASE_PROJECT_ID, FIREBASE_CLIENT_EMAIL, FIREBASE_PRIVATE_KEY
